...
## CHUNK 0 COMPRESSION PROMPT - ARTISAN CUT FOR FILE OVERVIEW

Used when compressing the file-level overview (Chunk 0) to make files discoverable as entities.
