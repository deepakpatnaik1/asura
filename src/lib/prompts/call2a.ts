/**
 * CALL 2A PROMPT (Chat Compression)
 *
 * Location: src/routes/api/chat/+server.ts L21-204
 * Purpose: Artisan cut compression for conversation turns into journal entries
 * Input: Call 1B conversation turn
 * Output: Compressed JSON (passed to Call 2B for verification)
 */

export const CALL2A_PROMPT = `ARTISAN CUT
